...
later(function()
  ...
  set('n', '<leader>lS', '<Cmd>Pick lsp scope="workspace_symbol"<CR>', { desc = 'Symbols workspace' })
  set('n', '<leader>ly', '<CmdPick lsp scope="type_definition"<CR>', { desc = 'Type definition' })
  set('n', '<leader>ls', '<Cmd>Pick lsp scope="document_symbol"<CR>', { desc = 'Symbols document' })
  set('n', '<leader>lX', '<Cmd>Pick diagnostic scope="all"<CR>', { desc = 'Diagnostic workspace' })
  set('n', '<leader>lx', '<Cmd>Pick diagnostic scope="current"<CR>', { desc = 'Diagnostic buffer' })
...
later(function()
  ...
  local prettier = function() return { 'prettier' } end
  local python = function() return { 'rufff_organize_imports', 'ruff_fix', 'ruff_format' } end
  local lua = function() return { 'stylua' } end
  local default = function() return { 'trim_whitespace', 'trim_newline' } end
