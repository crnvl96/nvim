MiniDeps.now(function()
  ...
  vim.keymap.set(
    'c',
    '<C-n>',
    function() vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('<Tab>', true, false, true), 't', true) end
  )
  vim.keymap.set(
    'c',
    '<C-p>',
    function() vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('<S-Tab>', true, false, true), 't', true) end
  )
end)
