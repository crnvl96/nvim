...
s('fl', 'Pick buf_lines scope="current"', 'minipick: lines (current)')
...
s('gca', 'Git commit --amend', 'minigit: amend last commit')
s('gcc', 'Git commit', 'minigit: commit')
s('gdc', 'Git diff --cached', 'minigit: show diff of added files')
s('gdd', 'Git diff', 'minigit: diff')
...
function LspOnAttachMaps(bufnr)
  ...
  ls('le', 'lua vim.lsp.buf.hover()', 'lsp: hover on cursor')
  ls('lh', 'lua vim.lsp.buf.signature_help()', 'lsp: arguments popup')
  ...
  ls('ll', 'lua vim.diagnostic.open_float()', 'lsp: diagnostics popup')
